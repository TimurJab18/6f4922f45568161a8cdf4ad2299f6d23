...
<div class="settings-wrap">
  ...
  <div class="nav">
    ...
    <a href="/settings/change_password" class="nav-link nav-link__active">Сменить пароль</a>
...
<div class="clear"></div>
 <div class="settings-info__container" style="width:340px;margin:0 auto;padding:35px 0 35px">
   ...
   <div class="input_wrap" style="margin-bottom:21px;">
		<span style="font-weight: bold;font-size:19px">Смена пароля</span>
  	  </div>
...
?>
   ...
   <div class="input_wrap">
   	<div class="input_wrap_title">Старый пароль:</div>
		<input type="text" name="settings_first_name" class="text_field settings-text_field" placeholder="Ввведите старый проль">
  	  </div>
      
   <div class="input_wrap">
    <div class="input_wrap_title">Новый пароль:</div>
    <input type="text" name="settings_last_name" class="text_field settings-text_field" placeholder="Ввведите новый проль">
      </div>
